    ...
    <>
      ...
      <article className="content-page">
        ...
        <section>
          ...
          <p>입력한 내용으로 기존 A4 학습지를 PDF로 저장하거나 인쇄할 수 있고, 같은 내용을 손가락·스타일러스·마우스로 화면에서 따라 쓸 수도 있습니다. 화면 연습이 끝나면 전체 글자 또는 다시 써본 글자를 기존 인쇄 학습지 입력창으로 자동 연결합니다.</p>
        </section>
        ...
        <section>
          ...
          <div className="value-list">
            ...
            <div><strong>부모 중심</strong><p>숫자 평가 대신 한 획씩 따라 쓰고 끝까지 완성하는 경험을 중심으로 안내합니다.</p></div>
        ...
        <section className="callout-section">
          ...
          <p>입력한 이름과 단어는 서버로 전송되지 않습니다. 화면 연습을 완료하면 날짜, 시작·완료 시간, 완성한 글자와 재시도 횟수만 현재 브라우저에 저장됩니다. 필기 이미지와 실제 획 좌표는 기록에 저장하지 않습니다.</p>
          <a href="/privacy/">개인정보 처리방침 확인하기</a>
        </section>

        <section>
          <h2>편안하게 활용하려면</h2>
          <p>아이의 나이보다 현재 쓰기 경험과 집중 시간을 기준으로 분량을 조절해 주세요. 화면 연습은 교육기관의 공식 진단이 아니므로 결과를 평가하기보다 시작점과 방향을 보고 끝까지 다시 시도한 과정을 함께 칭찬해 주세요.</p>
  ...
  return (
    <>
      ...
      <article className="content-page policy-page">
        ...
        <section>
          <h2>3. 화면 필기와 획 판정</h2>
          <p>필기 좌표와 캔버스 이미지는 외부 LLM, 이미지 분석 API 또는 운영자 서버로 보내지 않습니다. 현재 획의 시작점, 끝점, 진행 방향, 기준 경로 근접도와 커버리지 비교는 현재 브라우저에서 실행됩니다.</p>
          <p>필기 이미지, 캔버스 PNG와 실제 획 좌표 원본은 연습 기록에 저장하지 않습니다. 획 판정은 연습 진행을 돕기 위한 기능이며 전문 교육 또는 의료 진단이 아닙니다.</p>
        </section>

        <section>
          <h2>4. 브라우저에 저장되는 연습 기록</h2>
          <p>화면 연습을 완료하면 날짜, 시작·완료 시간, 연습한 글자, 완성한 글자 수, 글자별 재시도 횟수와 총 연습 시간이 버전이 지정된 브라우저 저장소에만 보관됩니다.</p>
        ...
        <section>
          ...
          <p>광고는 필기 캔버스와 현재 글자 처음부터·획 안내 다시 보기처럼 아이가 반복해서 누르는 영역 주변에는 배치하지 않습니다. 맞춤 광고 설정은 해당 광고 서비스가 제공하는 관리 화면에서 변경할 수 있습니다.</p>
        </section>
...
export function TermsPage() {
  return (
    <>
      <Seo
        title="이용약관"
        description="오늘의 한글 학습지와 화면 획순 연습의 이용 범위, 출력 및 사용자 책임을 안내합니다."
        path="/terms"
      />
      <article className="content-page policy-page">
        <PageHeader
          ...
          description="인쇄 학습지와 화면 획순 따라쓰기의 활용 범위를 확인해 주세요."
        />
        <p className="policy-date">시행일 및 최종 수정일: 2026년 7월 26일</p>
        ...
        <section><h2>2. 전문 진단이 아님</h2><p>화면 연습은 자모별 기준 경로와 현재 한 획을 비교해 연습 순서를 안내합니다. 언어 발달·학습 장애·운동 발달에 관한 교육 또는 의료 진단을 제공하지 않습니다.</p></section>
        ...
        <section><h2>4. 출력 및 사용 책임</h2><p>인쇄 전 철자, 용지 크기와 배율을 확인할 책임은 사용자에게 있습니다. 브라우저, 프린터, 글꼴과 입력 기기 차이로 출력 또는 화면 필기 반응이 달라질 수 있습니다.</p></section>
